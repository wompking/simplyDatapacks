...
execute as @s[tag=PAUSE] if block ~ ~-1 ~ minecraft:iron_block at @e[tag=SimplyBFTape,limit=1,sort=nearest] store result block ~ ~-1 ~ Items[0].tag.BFTapeValue int 1 run scoreboard players get @p BFNumpad
